...
<form action="{{ route('timeslot.update',$time->id) }}" method="post">
            @csrf
            @method('PUT')
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="time" id="firstname" name="start_time" class="form-control" value="{{ $time->start_time }}">
                </div>
                <div class="col-md-6 mb-3">
                    <label for="lastname" class="form-label">End Time</label>
                    <input type="time" id="lastname" name="end_time" class="form-control" value="{{ $time->end_time }}">
                </div>
            </div>
