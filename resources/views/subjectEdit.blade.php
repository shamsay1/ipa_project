        ...
        <form action="{{ route('subject.update', $subject->id)}}" method="post">
            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" id="subjectName" name="subjectName" class="form-control" value="{{ $subject->subjectName }}">
                </div>

                <div class="col-md-4 mb-3">
                    <label for="subjectCode" class="form-label">Subject Code</label>
                    <input type="text" id="subjectCode" name="subjectCode" class="form-control" value="{{ $subject->subjectCode }}">
                </div>
            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                    ...
                    <select name="course_id" class="selectpicker w-100" data-live-search="true">
                        ...
                        <option value="{{ $co->id}}" {{ $subject->course_id == $co->id ? "selected" : ""}}>{{ $co->courseName }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <select name="nta_level" class="form-select">
                        <option value="NTA-4" {{ $subject->nta_level == "NTA-4" ? "selected" : ""}}>NTA-4</option>
                        <option value="NTA-5" {{ $subject->nta_level == "NTA-5" ? "selected" : ""}}>NTA-5</option>
                        <option value="NTA-6" {{ $subject->nta_level == "NTA-6" ? "selected" : ""}}>NTA-6</option>
                        <option value="NTA-7" {{ $subject->nta_level == "NTA-7" ? "selected" : ""}}>NTA-7</option>
                        <option value="NTA-8" {{ $subject->nta_level == "NTA-8" ? "selected" : ""}}>NTA-8</option>
                    </select>
                </div>
