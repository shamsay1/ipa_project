...
@section("content")
 <div id="content">
    ...
    <div class="col-md-7 d-flex flex-wrap align-items-center mb-3 mb-md-0 gap-2">
        <form action="{{ route('class.import') }}" method="POST" enctype="multipart/form-data" id="importForm" style="display:none;">
            @csrf
        ...
        <a href="{{ route('class.template')}}" class="btn btn-info text-white">
            ...
            <div class="table-responsive">
                <table class="table table-hover">
                    ...
                    <tbody id="roomTableBody">
                        @include('partials.room_table', ['rooms' => $rooms])
