...
<form action="{{ route('department.update', $dept->id)}}" method="post">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <input type="text" id="firstname" name="deptName" class="form-control" value="{{ $dept->deptName}}">
                </div>
                <div class="col-md-6">
                    <label for="firstname" class="form-label">Department Code</label>
                    <input type="text" name="dept_code" class="form-control" value="{{ $dept->dept_code}}">
                </div>
