    ...
    <header>
        <div class="nav">
            ...
            <ul>
                ...
                <li><a href="{{ url('/teachersub') }}" style="color: #c9a227;">Subjects</a></li>
                <li><a href="{{ url('/teachettbl') }}">Timetable</a></li>
                <li><a href="{{ url('/profile') }}">Profile</a></li>
                <li><a href="{{ url('/attendance') }}">Emergency less</a></li>
                <li><a href="{{ url('/attendance1') }}">View attendance</a></li>
                <li>
    ...
    <section class="container mt-5">
        <div class="table-scroll shadow" style="border-radius: 5px">
           <div class="text-center" style="margin-bottom: 35px;">
            <img src="{{ asset('images/ipalogo1.png') }}" alt="IPA Logo" width="100">
            <h3 style="margin-top: 15px; color: #0f2a44; letter-spacing: 0.5px;">INSTITUTE OF PUBLIC AND ADMINISTRATION</h3>
            <h5 style="color: #64748b; margin-top: 5px; font-weight: 500;">MWALIMU: <b style="color: #0f2a44;">{{ Auth::user()->firstname }} {{ Auth::user()->middlename }} {{ Auth::user()->lastname }}</b></h5>
        </div>
        ...
        <div id="subjects-section">
            ...
            <div class="cards-grid">
                @forelse ($subjects as $subject)
                    <div class="subject-card" onclick="showAttendance('{{ $subject->id }}', '{{ $subject->subjectName }} ({{ $subject->subjectCode }})')">
                        <div>
                            <h3>{{ $subject->subjectName }}</h3>
                            <p><b>Code:</b> {{ $subject->subjectCode }}</p>
                            <p><b>Level:</b> {{ $subject->nta_level }}</p>
                        </div>
        ...
        <div id="attendance-section" class="d-none">
            ...
            <div class="table-scroll">
                @foreach ($subjects as $subject)
                    ...
                    <table id="attendance-table-{{ $subject->id }}" class="attendance-table d-none">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            @forelse ($subject->attendances as $index => $attendance)
                                <tr>
                                    <td>{{ $index + 1 }}</td>
                                    ...
                                    <td style="text-align: center;">
                                        @if($attendance->status2 == 'present' || $attendance->status == 'present')
