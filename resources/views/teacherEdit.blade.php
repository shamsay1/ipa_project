...
<form action="{{ route('teachers.update', $teacher->id)}}" method="post">
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" id="email" name="middlename" class="form-control" value="{{ $teacher->middlename}}">
                </div>
                <div class="col-md-4 mb-3">
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" id="firstname" name="mobile" class="form-control" value="{{ $teacher->mobile}}">
                </div>
                <div class="col-md-4 mb-3">
            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" id="email" name="teacher_code" class="form-control" value="{{ $teacher->teacher_code}}">
                </div>
                <div class="col-md-4 mb-3">
    ...
    <select name="deptId" id="department" class="form-control" required>
        <option value="{{ $teacher->deptId }}" selected>
            {{ $teacher->department->deptName ?? 'Unknown Department' }}
        </option>
    </select>
</div>
