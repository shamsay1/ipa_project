        ...
        <div class="row mb-4">
            <div class="row align-items-center mb-4">
                <div class="col-md-7 d-flex flex-wrap align-items-center mb-3 mb-md-0 gap-2">
                    <form action="{{ route('teacher.import') }}" method="POST" enctype="multipart/form-data" id="importForm" style="display:none;">
                        @csrf
                    ...
                    <a href="{{ route('teacher.template')}}" class="btn btn-info text-white">
  ...
  <div class="d-flex align-items-center">
    ...
    <table class="table table-hover">
        ...
        <tbody id="teacherTableBody">
            @include('partials.teacher_table', ['teachers' => $teachers])
        </tbody>
    </table>
