...
Logout
 ...
 <div class="page-content">
     ...
     <h3 style="text-align: center;margin-top: 10px">INSTITUTE OF PUBLIC AND ADMINISTRATION</h3>
                <h5 style="text-align: center">STUDENT NAME: <b>{{ Auth::guard('cr')->user()->firstname }} {{ Auth::guard('cr')->user()->middlename }} {{ Auth::guard('cr')->user()->lastname }}</b></h5><br>
    ...
    <div class="col-md-6">
        <div class="password-card">
            <h4 style="text-align: center">Changing password form</h4>
             ...
             <form action="{{ route('profile.changePassword1') }}" method="POST">
                @csrf
