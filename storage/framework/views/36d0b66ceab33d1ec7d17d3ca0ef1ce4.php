...
<div class="modal fade" id="addTeacherModal" tabindex="-1" aria-labelledby="addTeacherModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <form action="<?php echo e(route('timeslot.store')); ?>" method="POST">
        <?php echo csrf_field(); ?>
    ...
    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
            ...
            <div class="table-responsive">
                <table class="table table-hover">
                    ...
                    <tbody>
    <?php $i = 1; ?>
    <?php $__empty_1 = true; $__currentLoopData = $timeslot; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $time): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <tr>
            <td><?php echo e($i++); ?></td>
            ...
            <td>
    <!-- Edit button -->
    <a href="<?php echo e(route('timeslot.edit', $time->id)); ?>" class="btn btn-sm btn-outline-primary" title="Edit">
        <i class="bi bi-pencil-square"></i>
    </a>

    <!-- Delete button with confirmation -->
    <form action="<?php echo e(route('timeslot.destroy', $time->id)); ?>" method="POST" style="display:inline;" 
...
<?php echo $__env->make("layout.app", array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\PC\Documents\Timetable\resources\views/timeslot.blade.php ENDPATH**/ ?>