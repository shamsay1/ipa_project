...
<body>
    <div class="login-container">
        ...
        <form action="<?php echo e(route('login')); ?>" method="POST">
            ...
            <div>
                <?php if(session("custom")): ?>
                <p style="color: red;text-align: center"><?php echo e(session("custom")); ?></p>
                <?php endif; ?>
            </div>
...
</html><?php /**PATH C:\Users\PC\Documents\Timetable\resources\views/login.blade.php ENDPATH**/ ?>