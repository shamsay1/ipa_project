            ...
            <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                    <div class="text-xs font-weight-bold text-primary mb-1">
                        Total Session</div>
                    <div class="h5 mb-0 font-weight-bold text-gray-800 stat-number"><?php echo e($totalLessons); ?></div>
                </div>
                <div class="col-auto">
            ...
            <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                    <div class="text-xs font-weight-bold text-success mb-1">
                        Taught Lessons</div>
                    <div class="h5 mb-0 font-weight-bold text-gray-800 stat-number"><?php echo e($taughtLessons); ?></div>
                </div>
                <div class="col-auto">
            ...
            <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                    <div class="text-xs font-weight-bold text-info mb-1">
                        Not Taught</div>
                    <div class="h5 mb-0 font-weight-bold text-gray-800 stat-number"><?php echo e($notTaughtLessons); ?></div>
                </div>
                <div class="col-auto">
...
<div style="width:100%; height:400px;" class="mb-3">
    ...
    <h2 style="color: green;text-align: center;font-family: 'Times New Roman', Times, serif">Course Code Meanings</h2>
            <?php $__currentLoopData = $coursesData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <strong><?php echo e($course->course_code); ?></strong><span>= <?php echo e($course->courseName); ?></span><br>
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const taughtData = <?php echo json_encode($taughtData, 15, 512) ?>;
    const notTaughtData = <?php echo json_encode($notTaughtData, 15, 512) ?>;
...
<?php echo $__env->make("layout.app", array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\PC\Documents\Timetable\resources\views/supervdash.blade.php ENDPATH**/ ?>