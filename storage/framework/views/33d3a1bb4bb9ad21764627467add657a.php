...
<body>
  ...
  <div class="page-content">
    ...
    <button 
        ...
        data-course="<?php echo e(auth()->user()->courseName ?? ''); ?>"
        data-nta="NTA <?php echo e(auth()->user()->nta_level ?? ''); ?>"
        data-group="<?php echo e(auth()->user()->group_name ?? ''); ?>"
        data-semester="<?php echo e($timetable['semester'] ?? ''); ?>"
        data-active="<?php echo e($timetable['active'] ?? ''); ?>"
