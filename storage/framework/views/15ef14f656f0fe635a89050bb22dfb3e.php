...
<div class="row">
    <div class="col-md-12">
        <form action="<?php echo e(route('teacher.load.report1')); ?>" method="GET" class="row g-3">
            <?php echo csrf_field(); ?>
            <div class="col-md-4">
...
<?php echo $__env->make("layout.app", array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\PC\Documents\Timetable\resources\views/report.blade.php ENDPATH**/ ?>