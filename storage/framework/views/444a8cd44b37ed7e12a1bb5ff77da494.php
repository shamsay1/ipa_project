                    ...
                    <section class="container">
                                            ...
                                            <tr>
                                                ...
                                                <?php $__currentLoopData = $timetable['timeslots']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <td>
                                                        ...
                                                        ?>
                                                        <?php if($found): ?>
                                                            <strong><?php echo e($found->subjectName); ?></strong><br>
                                                            <?php echo e($found->courseName); ?> (NTA <?php echo e($found->nta_level); ?>)<br>
                        ...
                        <div class="no-pdf">
                            ...
                            <button 
                                ...
                                data-course="<?php echo e($timetable['course'] ?? 'COURSE NAME'); ?>"
                                data-nta="<?php echo e($timetable['nta_level'] ?? 'NTA LEVEL'); ?>"
                                data-group="<?php echo e($timetable['group_name'] ?? ''); ?>"
                                data-semester="<?php echo e($activeSemester->semName ?? 'SEMESTER UNKNOWN'); ?>"
                                data-active="<?php echo e($activeSemester->academic_year ?? 'YEAR UNKNOWN'); ?>"
                            >
...
<?php /**PATH C:\Users\PC\Documents\Timetable\resources\views/layout/teacher.blade.php ENDPATH**/ ?>